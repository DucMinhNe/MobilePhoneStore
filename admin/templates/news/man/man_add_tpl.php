                                ...
                                <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                                    <?php foreach ($config['website']['lang'] as $k => $v) { ?>
                                        <div class="tab-pane fade show <?= ($k == 'vi') ? 'active' : '' ?>" id="tabs-lang-<?= $k ?>" role="tabpanel" aria-labelledby="tabs-lang">
                                            ...
                                            <?php if (isset($config['news'][$type]['dongia']) && $config['news'][$type]['dongia'] == true) { ?>
                                                <div class="form-group">
                                                    <label for="dongia<?= $k ?>">Đơn giá (<?= $k ?>):</label>
                                                    <input type="text" class="form-control for-seo text-sm" name="data[dongia<?= $k ?>]" id="dongia<?= $k ?>" placeholder="Đơn giá (<?= $k ?>)" value="<?= (!empty($flash->has('dongia' . $k))) ? $flash->get('dongia' . $k) : @$item['dongia' . $k] ?>" >
                                                </div>
                                            <?php } ?>
                                            <?php if (isset($config['news'][$type]['quytrinh']) && $config['news'][$type]['quytrinh'] == true) { ?>
                                                <div class="form-group">
                                                    <label for="quytrinh<?= $k ?>">Quy trình (<?= $k ?>):</label>
                                                    <input type="text" class="form-control for-seo text-sm" name="data[quytrinh<?= $k ?>]" id="quytrinh<?= $k ?>" placeholder="Quy trình (<?= $k ?>)" value="<?= (!empty($flash->has('quytrinh' . $k))) ? $flash->get('quytrinh' . $k) : @$item['quytrinh' . $k] ?>" >
                                                </div>
                                            <?php } ?>
