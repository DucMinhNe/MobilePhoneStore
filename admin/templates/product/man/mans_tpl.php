                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            <a class="text-dark text-break"
                                ...
                                title="<?= $items[$i]['namevi'] ?>"><?= $items[$i]['namevi'] ?></a>
                            <div class="tool-action mt-2 w-clear">
                                ...
                                <?php
                                            ...
                                            ?>
                                <a class="text-primary mr-3" href="<?= $linkComment ?>&id=<?= $items[$i]['id'] ?>"
                                    title="<?= $items[$i]['namevi'] ?>"><i
                                        class="fas fa-comments mr-1"></i>(<?= $items[$i]['totalComment'] ?>) Comment
                                    <?= (!empty($items[$i]['newComment'])) ? '<span class="badge badge-danger align-top">' . $items[$i]['newComment'] . '</span>' : '' ?></a>
                                <?php } ?>
                                <?php if (isset($config['product'][$type]['view']) && $config['product'][$type]['view'] == true) { ?>
                                <a class="text-primary mr-3" href="<?= $linkView ?><?= $items[$i]['slugvi'] ?>"
                                    target="_blank" title="<?= $items[$i]['namevi'] ?>"><i
                                        class="far fa-eye mr-1"></i>View</a>
                                <?php } ?>
                                <a class="text-info mr-3"
                                    href="<?= $linkEdit ?><?= $linkID ?>&id=<?= $items[$i]['id'] ?>"
                                    title="<?= $items[$i]['namevi'] ?>"><i class="far fa-edit mr-1"></i>Edit</a>
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul aria-labelledby="dropdownCopy" class="dropdown-menu border-0 shadow">
                                        <li><a href="#" class="dropdown-item copy-now" data-id="<?= $items[$i]['id'] ?>"
                                                data-table="product" data-copyimg="<?= $copyImg ?>"><i
                                ...
                                <a class="text-danger" id="delete-item"
                                    ...
                                    title="<?= $items[$i]['namevi'] ?>"><i class="far fa-trash-alt mr-1"></i>Delete</a>
                            </div>
                        </td>
                        <?php if (isset($config['product'][$type]['gallery']) && count($config['product'][$type]['gallery']) > 0) { ?>
                        <td class="align-middle">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdown-gallery">
                                    ...
                                    <a class="dropdown-item text-dark"
                                        href="<?= $linkMulti ?>&id_parent=<?= $items[$i]['id'] ?>&val=<?= $key ?>"
                        ...
                        <td class="align-middle text-center">
                            <div class="custom-control custom-checkbox my-checkbox">
                                <input type="checkbox" class="custom-control-input show-checkbox"
                                    id="show-checkbox-<?= $key ?>-<?= $items[$i]['id'] ?>" data-table="product"
