                ...
                <div class="row">
                    ...
                    <?php if (isset($config['setting']['link_googlemaps']) && $config['setting']['link_googlemaps'] == true) { ?>
                        <div class="form-group col-md-4 col-sm-6">
                            ...
                            <input type="text" class="form-control text-sm" name="data[options][tiktok]" id="tiktok" placeholder="Link tiktok" value="<?= (!empty($flash->has('tiktok'))) ? $flash->get('tiktok') : @$options['tiktok'] ?>">
                        </div>
                        <div class="form-group col-md-4 col-sm-6">
