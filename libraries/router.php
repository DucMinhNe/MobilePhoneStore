...
$requick = array(
    ...
    array("tbl" => "news_list", "field" => "idl", "source" => "news", "com" => "blogs", "type" => "blogs"),
    array("tbl" => "news", "field" => "id", "source" => "news", "com" => "blogs", "type" => "blogs", "menu" => true),

    array("tbl" => "news_list", "field" => "idl", "source" => "news", "com" => "sua-chua", "type" => "sua-chua"),
    array("tbl" => "news_cat", "field" => "idc", "source" => "news", "com" => "sua-chua", "type" => "sua-chua"),
    array("tbl" => "news", "field" => "id", "source" => "news", "com" => "sua-chua", "type" => "sua-chua", "menu" => true),
...
switch ($com) {
    ...
    case 'tra-cuu-bao-hanh':
        $source = "static";
        $template = "static/tracuubaohanh";
        $type = $com;
        $seo->set('type', 'object');
        $titleMain = "Tra cứu bảo hành";
        break;
    ...
    case 'sua-chua':
        $source = "news";
        $template = isset($_GET['id']) ? "news/news_detail" : "news/suachua";
        $seo->set('type', isset($_GET['id']) ? "article" : "object");
        $type = $com;
        $titleMain = "Sửa chữa";
        break;
    ...
    case 'keo-thom':
        $source = "product";
        $template = isset($_GET['id']) ? "product/product_detail" : "product/product";
        $seo->set('type', isset($_GET['']) ? "article" : "object");
        $type = "san-pham";
        $keothom = true;
        $titleMain = "Kèo thơm";
        break;
