<?php /* if (count($hotsale)) { ?>
    <div class="wrap-product wrap-content">
        <div class="title-main title-hotsale"><img src="assets/images/icon-hotsale.png" alt=""></div>
        <div class="owl-page owl-carousel owl-theme" data-items="screen:0|items:2|margin:2,screen:1199|items:5|margin:7" data-rewind="1" data-autoplay="1" data-loop="0" data-lazyload="0" data-mousedrag="1" data-touchdrag="1" data-smartspeed="300" data-autoplayspeed="500" data-autoplaytimeout="3500" data-dots="0" data-nav="0" data-navcontainer="">
            <?php foreach ($hotsale as $k => $v) { ?>
                <div class="box-product">
                    <div class="pic-product">
                        <a class="text-decoration-none" href="<?= $v[$sluglang] ?>" title="<?= $v['name' . $lang] ?>">
                            <img class="lazy" onerror="this.src='<?= THUMBS ?>/202x228x2/assets/images/noimage.png';" data-src="<?= WATERMARK ?>/product/202x228x2/<?= UPLOAD_PRODUCT_L . $v['photo'] ?>" alt="<?= $v['name' . $lang] ?>" title="<?= $v['name' . $lang] ?>" />
                        </a>
                    </div>
                    <div class="info-prod">
...
<?php if (count($hotsale)) { ?>
    <div class="wrap-product wrap-content">
        ...
        <div class="paging-product-hotsalemb"></div>
    </div>
<?php } ?>
                ...
                <?php foreach ($thuvien as $k => $v) { ?>
                    <div class="album_item ">
                        <a class="scale-img" data-fancybox="gallery" data-src="<?= ASSET . UPLOAD_PRODUCT_L . $v['photo'] ?>" data-caption="" rel="album-<?= $v['id'] ?>" title="<?= $v['name' . $lang] ?>">
                            <img class="w-100" onerror="this.src='<?= THUMBS ?>/300x300x1/assets/images/noimage.png';" src="<?= THUMBS ?>/300x300x1/<?= UPLOAD_PRODUCT_L . $v['photo'] ?>" alt="<?= $v['name' . $lang] ?>" title="<?= $v['name' . $lang] ?>" />
                        </a>
                    </div>
                <?php } ?>
            </div>
...
<?php /* if (count($productHot)) {
    ...
    <div class="product__hot wrap-content">
        <div class="owl-page owl-carousel owl-theme" data-items="screen:0|items:2|margin:5" data-rewind="1" data-autoplay="1" data-loop="0" data-lazyload="0" data-mousedrag="1" data-touchdrag="1" data-smartspeed="300" data-autoplayspeed="500" data-autoplaytimeout="3500" data-dots="1" data-nav="0" data-navcontainer="">
                ...
                <div class="productList-col">
                    <?php foreach ($chunk as $k => $v) { ?>
                        <div class="box-product">
                            <div class="pic-product">
                                <a class="text-decoration-none" href="<?= $v[$sluglang] ?>" title="<?= $v['name' . $lang] ?>">
                                    <img class="lazy w-100" onerror="this.src='<?= THUMBS ?>/202x228x2/assets/images/noimage.png';" data-src="<?= WATERMARK ?>/product/202x228x2/<?= UPLOAD_PRODUCT_L . $v['photo'] ?>" alt="<?= $v['name' . $lang] ?>" title="<?= $v['name' . $lang] ?>" />
                                </a>
                            </div>
                            <div class="info-prod">
                                <h3 class="mb-0"><a class="text-decoration-none text-split2 name-product" href="<?= $v[$sluglang] ?>" title="<?= $v['name' . $lang] ?>"><?= $v['name' . $lang] ?></a></h3>
    ...
    <div class="wrap-intro">
        <div class="wrap-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="div_hiden">
                        <div class="owl-page owl-carousel owl-theme owl-video" data-items="screen:0|items:2|margin:15,screen:1199|items:3|margin:20" data-rewind="1" data-autoplay="1" data-loop="0" data-lazyload="0" data-mousedrag="1" data-touchdrag="1" data-smartspeed="300" data-autoplayspeed="500" data-autoplaytimeout="3500" data-dots="0" data-nav="1" data-navcontainer=".control-video">
...
<?php if (count($newsHot)) { ?>
    <div class="wrap-newsnb padding-top-bottom">
        <div class="wrap-content">
            ...
            <div class="owl-page owl-carousel owl-theme" data-items="screen:0|items:2|margin:20,screen:1199|items:4|margin:20" data-rewind="1" data-autoplay="1" data-loop="0" data-lazyload="0" data-mousedrag="1" data-touchdrag="1" data-smartspeed="300" data-autoplayspeed="500" data-autoplaytimeout="3500" data-dots="0" data-nav="0" data-navcontainer=".control-news">
                ...
                <div class="owl-product">
                    <div class="owl-page owl-carousel owl-theme" data-items="screen:0|items:2|margin:5" data-rewind="1" data-autoplay="1" data-loop="0" data-lazyload="0" data-mousedrag="1" data-touchdrag="1" data-smartspeed="300" data-autoplayspeed="500" data-autoplaytimeout="3500" data-dots="0" data-nav="0" data-navcontainer=".control-product">
                        <?php foreach ($fb_chunk as $chunk) { ?>
                            <div class="productList-col mr-2">
                                <?php foreach ($chunk as $k => $v) { ?>
                                    <div class="fb-page" data-href="<?= $v['name' . $lang] ?>" data-tabs="timeline" data-width="150" data-height="200" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
