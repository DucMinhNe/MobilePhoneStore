    ...
    <div class="footer-article">
        <div class="wrap-content padding-top-bottom d-flex flex-wrap justify-content-between ">
            ...
            <div class="footer-news">
                ...
                <blockquote class="tiktok-embed" cite="https://www.tiktok.com/@<?= $tiktok['name' . $lang] ?>" data-unique-id="<?= $tiktok['name' . $lang] ?>" data-embed-from="embed_page" data-embed-type="creator" style="max-width: 720px; min-width: 370px;">
...
<a class="btn-zalo btn-frame btn-frame2 text-decoration-none" target="_blank" href="https://zalo.me/<?= preg_replace('/[^0-9]/', '', $optsetting['zalo']); ?>">
    <div class="animated infinite zoomIn kenit-alo-circle"></div>
    <div class="animated infinite pulse kenit-alo-circle-fill"></div>
    <i><?= $func->getImage(['size-error' => '35x35x2', 'upload' => 'assets/images/', 'image' => 'zl.png', 'alt' => 'Zalo']) ?></i>
</a>

<a class="btn-phone btn-frame btn-frame2 text-decoration-none" href="tel:<?= preg_replace('/[^0-9]/', '', $optsetting['hotline']); ?>">
    <div class="animated infinite zoomIn kenit-alo-circle"></div>
    <div class="animated infinite pulse kenit-alo-circle-fill"></div>
    <i><?= $func->getImage(['size-error' => '35x35x2', 'upload' => 'assets/images/', 'image' => 'hl.png', 'alt' => 'Hotline']) ?></i>
</a>

<a class="btn-map btn-frame btn-frame2 text-decoration-none" target="_blank" href="<?= $optsetting['link_googlemaps']; ?>">
    <div class="animated infinite zoomIn kenit-alo-circle"></div>
    <div class="animated infinite pulse kenit-alo-circle-fill"></div>
    <i><?= $func->getImage(['size-error' => '35x35x2', 'upload' => 'assets/images/', 'image' => 'location.png', 'alt' => 'Map']) ?></i>
</a>

<a class="btn-tiktok btn-frame btn-frame2 text-decoration-none" target="_blank" href="<?= $optsetting['tiktok']; ?>">
    <div class="animated infinite zoomIn kenit-alo-circle"></div>
    <div class="animated infinite pulse kenit-alo-circle-fill"></div>
