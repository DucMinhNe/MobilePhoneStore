...
<div class="content-main">
    <div class="contact-article row">
        <div class="contact-text col-12"><?= htmlspecialchars_decode($lienhe['content' . $lang]) ?></div>
        <form class="contact-form validation-contact col-12" novalidate method="post" action="" enctype="multipart/form-data">
            <div class="row-20 row">
                <div class="contact-input col-6 col-20">
