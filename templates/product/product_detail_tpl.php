    ...
    <div class="mid-pro-detail">
        <ul class="attr-pro-detail">
            ...
            <li>
                ...
                <span class=""><?= $rowDetail['view'] ?></span>
            </li>
    ...
    <?php if (!empty($productList)) { ?>
        <div class="right-pro-detail">
            ...
            <div class="baohanh-pro-detail ">
                <?= ($func->decodeHtmlChars($productList['baohanh' . $lang])) ?>
            </div>
            <div class="text-baohanh-detail">Bạn sẽ được hỗ trợ khi mua máy</div>
            <div class="baohanh-pro-detail ">
                <?= ($func->decodeHtmlChars($productList['hotro' . $lang])) ?>
            </div>
        </div>
    <?php } else { ?>
        <div class="right-pro-detail">
