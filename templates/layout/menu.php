    ...
    <div class="menu">
        <div class="wrap-menu">
            <ul class="menu-main ulmn">
                ...
                <?php } ?>
                <li>
                    <a class="corlormenu <?php if ($com == 'sua-chua') echo 'active'; ?> transition" href="sua-chua" title="Sửa chữa"><span class="img-lv1"><img src="assets/images/icon-suachua.png" alt=""></span> SỬA CHỮA</a>
                ...
                <li><a class="<?php if ($com == 'blogs') echo 'active'; ?> transition" href="blogs" title="Blogs"><span class="img-lv1"><img src="assets/images/icon-tintuc.png" alt=""></span> Blogs</a>
                ...
                <li><a class="<?php if ($com == 'lien-he') echo 'active'; ?> transition" href="lien-he" title="Liên hệ"><span class="img-lv1"><img src="assets/images/contact.png" alt=""></span> Liên hệ</a></li>
            </ul>
        </div>
    </div>
</div>